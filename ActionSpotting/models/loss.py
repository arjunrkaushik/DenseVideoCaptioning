...
class MatchCriterion():
    ...
    def a2f_soft_iou(self, a2f_attn, onehot_seg_label):
        ...
        a2f_attn_np = to_numpy(a2f_attn)
        onehot_seg_label_np = to_numpy(onehot_seg_label)
    ...
    def match(self, clogit, a2f_attn):
        ...
        with torch.no_grad():
            ...
            if match_cfg.a2fc > 0:
                ...
                a2f_iou = to_numpy(a2f_iou)
                cost -= match_cfg.a2fc * a2f_iou

        cost = to_numpy(cost) # a, s
    ...
    def _one_to_many_match(self, cost):
        transcript_np = to_numpy(self.transcript)
    ...
    def cross_attn_loss_tdu(self, match, attn, tdu: TemporalDownsampleUpsample, dim=None):
        assert dim >= 1
        onehot_seg_label = self.onehot_seg_label
        aind, sind = match
